              ...
              >
                ...
                <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
                  ...
                  <div className="p-5 sm:p-6 overflow-y-auto flex-1 space-y-4">
                    ...
                    <RichTextEditor
                      label="Instrucciones & Preparación"
                      value={form.description}
                      onChange={(val) => setForm({ ...form, description: val })}
                      placeholder="Instrucciones paso a paso, tiempos de cocción, tips culinarios..."
                      minHeight="180px"
                      rows={8}
                    />
            ...
            {filtered.map(recipe => {
              ...
              return (
                <motion.div
                  ...
                  className="group bg-white/80 dark:bg-gray-900/80 glass dark:dark-glass p-6 md:p-8 rounded-[2rem] border-none shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between overflow-hidden relative"
                >
                  {/* Card Header */}
                  <div className="space-y-4 flex-1">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="flex items-center gap-1 shrink-0">
                        ...
                        <button onClick={() => deleteRecipe(recipe.id)} className="p-2 text-red-500 dark:text-red-400 bg-red-500/10 dark:bg-red-500/20 hover:bg-red-500/20 dark:hover:bg-red-500/35 border border-red-500/20 dark:border-red-500/30 rounded-xl transition-all shrink-0">
